...
//查询库存低于100的商品
    @Override
    public String queryGoods(Purchase purchase, Connection conn) throws SQLException {
...
//已有商品添加
    @Override
    public String addGoods(Purchase purchase, Connection conn) throws SQLException {
...
//添加商品
    @Override
    public String new_addGoods(Purchase purchase, Connection conn) throws SQLException {
...
//下架商品
    @Override
    public String deleteGoods(Purchase purchase, Connection conn) throws SQLException {
